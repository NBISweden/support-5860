              ...
              column(
                ...
                div(
                  ...
                  fluidRow(
                    div(
                      class = "col-xs-6",
                      numericInput("sc1a1oup1.h", "PDF / PNG height:",
                        min = 4, max = 20, value = 6, step = 0.5
                      )
                    ),
                    div(
                      class = "col-xs-6",
                      numericInput("sc1a1oup1.w", "PDF / PNG width:",
              ...
              column(
                ...
                div(
                  ...
                  fluidRow(
                    div(
                      class = "col-xs-6",
                      numericInput("sc1a1oup2.h", "PDF / PNG height:",
                        min = 4, max = 20, value = 6, step = 0.5
                      )
                    ),
                    div(
                      class = "col-xs-6",
                      numericInput("sc1a1oup2.w", "PDF / PNG width:",
                        min = 4, max = 20, value = 8, step = 0.5
                      )
                    )
                  ),
  ...
  tabPanel(
    ...
    fluidRow(
      column(
        ...
        fluidRow(
          column(
            12, selectInput("sc1a2drX", "X-axis:",
              choices = sc1conf[dimred == TRUE]$UI,
              selected = sc1def$dimred[1]
            ),
      ...
      column(
        3, actionButton("sc1a2togL", "Toggle to subset cells", class = "btn-sm"),
        conditionalPanel(
      ...
      column(
        6, actionButton("sc1a2tog0", "Toggle graphics controls", class = "btn-sm"),
        conditionalPanel(
    ...
    fluidRow(
      column(
        6,
        style = "border-right: 2px solid black", h4("Cell information 1"),
        fluidRow(
          column(
          ...
          column(
            6, actionButton("sc1a2tog1", "Toggle plot controls", class = "btn-sm"),
            conditionalPanel(
        ...
        downloadButton("sc1a2oup1.png", "Download PNG", class = "btn-sm"), br(),
        div(
          style = "display:inline-block",
          numericInput("sc1a2oup1.h", "PDF / PNG height:",
            width = "138px",
            min = 4, max = 20, value = 6, step = 0.5
          )
        ),
        div(
          style = "display:inline-block",
          numericInput("sc1a2oup1.w", "PDF / PNG width:",
            width = "138px",
            min = 4, max = 20, value = 8, step = 0.5
          )
        )
      ...
      column(
        ...
        fluidRow(
          ...
          column(
            6, actionButton("sc1a2tog2", "Toggle plot controls", class = "btn-sm"),
            conditionalPanel(
        ...
        div(
          style = "display:inline-block",
          numericInput("sc1a2oup2.h", "PDF / PNG height:",
            width = "138px",
            min = 4, max = 20, value = 6, step = 0.5
          )
        ),
        div(
          style = "display:inline-block",
          numericInput("sc1a2oup2.w", "PDF / PNG width:",
            width = "138px",
            min = 4, max = 20, value = 8, step = 0.5
          )
        )
  ...
  tabPanel(
    ...
    fluidRow(
      column(
        ...
        fluidRow(
          column(
            12, selectInput("sc1a3drX", "X-axis:",
              choices = sc1conf[dimred == TRUE]$UI,
              selected = sc1def$dimred[1]
            ),
      ...
      column(
        3, actionButton("sc1a3togL", "Toggle to subset cells", class = "btn-sm"),
        conditionalPanel(
      ...
      column(
        6, actionButton("sc1a3tog0", "Toggle graphics controls", class = "btn-sm"),
        conditionalPanel(
    ...
    fluidRow(
      column(
        ...
        fluidRow(
          ...
          column(
            6, actionButton("sc1a3tog1", "Toggle plot controls", class = "btn-sm"),
            conditionalPanel(
        ...
        downloadButton("sc1a3oup1.png", "Download PNG", class = "btn-sm"), br(),
        div(
          style = "display:inline-block",
          numericInput("sc1a3oup1.h", "PDF / PNG height:",
            width = "138px",
            min = 4, max = 20, value = 6, step = 0.5
          )
        ),
        div(
          style = "display:inline-block",
          numericInput("sc1a3oup1.w", "PDF / PNG width:",
            width = "138px",
            min = 4, max = 20, value = 8, step = 0.5
          )
        )
      ...
      column(
        ...
        fluidRow(
          ...
          column(
            6, actionButton("sc1a3tog2", "Toggle plot controls", class = "btn-sm"),
            conditionalPanel(
        ...
        downloadButton("sc1a3oup2.png", "Download PNG", class = "btn-sm"), br(),
        div(
          style = "display:inline-block",
          numericInput("sc1a3oup2.h", "PDF / PNG height:",
            width = "138px",
            min = 4, max = 20, value = 6, step = 0.5
          )
        ),
        div(
          style = "display:inline-block",
          numericInput("sc1a3oup2.w", "PDF / PNG width:",
            width = "138px",
            min = 4, max = 20, value = 8, step = 0.5
          )
        )
  ...
  tabPanel(
    ...
    fluidRow(
      column(
        ...
        fluidRow(
          column(
            12, selectInput("sc1b2drX", "X-axis:",
              choices = sc1conf[dimred == TRUE]$UI,
              selected = sc1def$dimred[1]
            ),
      ...
      column(
        3, actionButton("sc1b2togL", "Toggle to subset cells", class = "btn-sm"),
        conditionalPanel(
      ...
      column(
        6, actionButton("sc1b2tog0", "Toggle graphics controls", class = "btn-sm"),
        conditionalPanel(
    ...
    fluidRow(
      column(
        3,
        style = "border-right: 2px solid black", h4("Gene Expression"),
        ...
        actionButton("sc1b2tog1", "Toggle plot controls", class = "btn-sm"),
        conditionalPanel(
      ...
      column(
        ...
        downloadButton("sc1b2oup1.png", "Download PNG", class = "btn-sm"), br(),
        div(
          style = "display:inline-block",
          numericInput("sc1b2oup1.h", "PDF / PNG height:",
            width = "138px",
            min = 4, max = 20, value = 8, step = 0.5
          )
        ),
        div(
          style = "display:inline-block",
          numericInput("sc1b2oup1.w", "PDF / PNG width:",
            width = "138px",
  ...
  tabPanel(
    ...
    fluidRow(
      column(
        ...
        actionButton("sc1c1togL", "Toggle to subset cells", class = "btn-sm"),
        conditionalPanel(
        ...
        actionButton("sc1c1tog", "Toggle graphics controls", class = "btn-sm"),
        conditionalPanel(
      ...
      column(
        ...
        downloadButton("sc1c1oup.png", "Download PNG", class = "btn-sm"), br(),
        div(
          style = "display:inline-block",
          numericInput("sc1c1oup.h", "PDF / PNG height:",
            width = "138px",
            min = 4, max = 20, value = 8, step = 0.5
          )
        ),
        div(
          style = "display:inline-block",
          numericInput("sc1c1oup.w", "PDF / PNG width:",
            width = "138px",
            min = 4, max = 20, value = 10, step = 0.5
          )
        )
  ...
  tabPanel(
    ...
    fluidRow(
      column(
        ...
        actionButton("sc1c2togL", "Toggle to subset cells", class = "btn-sm"),
        conditionalPanel(
        ...
        actionButton("sc1c2tog", "Toggle graphics controls", class = "btn-sm"),
        conditionalPanel(
      ...
      column(
        ...
        downloadButton("sc1c2oup.png", "Download PNG", class = "btn-sm"), br(),
        div(
          style = "display:inline-block",
          numericInput("sc1c2oup.h", "PDF / PNG height:",
            width = "138px",
            min = 4, max = 20, value = 8, step = 0.5
          )
        ),
        div(
          style = "display:inline-block",
          numericInput("sc1c2oup.w", "PDF / PNG width:",
            width = "138px",
            min = 4, max = 20, value = 10, step = 0.5
          )
        )
  ...
  tabPanel(
    ...
    fluidRow(
      column(
        ...
        br(),
        actionButton("sc1d1togL", "Toggle to subset cells", class = "btn-sm"),
        conditionalPanel(
        ...
        actionButton("sc1d1tog", "Toggle graphics controls", class = "btn-sm"),
        conditionalPanel(
      ...
      column(
        ...
        downloadButton("sc1d1oup.png", "Download PNG", class = "btn-sm"), br(),
        div(
          style = "display:inline-block",
          numericInput("sc1d1oup.h", "PDF / PNG height:",
            width = "138px",
            min = 4, max = 20, value = 10, step = 0.5
          )
        ),
        div(
          style = "display:inline-block",
          numericInput("sc1d1oup.w", "PDF / PNG width:",
            width = "138px",
            min = 4, max = 20, value = 10, step = 0.5
          )
        )
